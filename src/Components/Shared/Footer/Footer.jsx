...
export default function Footer() {
    ...
    return (
        <div>
            <footer className="w-full lg:mt-10 md:mt-6 mt-4 ">
                <div className="mx-auto container px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-8 lg:py-10 md:py-6 py-4  max-w-xs mx-auto sm:max-w-2xl lg:max-w-full">
                        <div className="col-span-full lg:mb-10 max-lg:border-b max-lg:pb-8 lg:border-r border-gray-200 lg:col-span-2 lg:max-w-xs ">
                            <h1 className='w-full lg:text-3xl md:text-2xl  text-xl fonts-medium
                             text-indigo-500 hover:text-indigo-600  px-2 pb-4 flex items-center justify-center lg:justify-start'> Sayu Japthai </h1>
                            ...
                            <ul className="grid gap-5">
                                ...
                                <li className="flex items-center justify-center gap-2 lg:justify-start">
                                    ...
                                    36 rue jean baptiste clement saint Denis 93200
                                </li>
                            </ul>
                        </div>

                        <div className="lg:mx-auto text-left ">
                            <h4 className="text-lg text-white font-medium mb-7">Sayu Japthai </h4>
                        ...
                        <div className="lg:mx-auto text-left">
                            ...
                            <ul className="text-sm  transition-all duration-500">
                                <li className="mb-6">
                                    <Link to={'/'} className="text-gray-300 hover:text-white">Figma UI System</Link>
                                </li>
                                <li className="mb-6">
                                    <Link to={'/'} className=" text-gray-300 hover:text-white">Icons Assets</Link>
                                </li>
                                <li>
                                    <Link to={'/'} className=" text-gray-300 hover:text-white">Responsive Blocks</Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="lg:mx-auto text-left ">
                            ...
                            <ul className="text-sm  transition-all duration-500">
                                <li className="mb-6">
                                    <Link o={'/'} className="text-gray-300 hover:text-white">FAQs</Link>
                                </li>
                                <li className="mb-6">
                                    <Link o={'/'} className=" text-gray-300 hover:text-white">Quick Start</Link>
                                </li>
                                <li >
                                    <Link o={'/'} className=" text-gray-300 hover:text-white">Documentation</Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="lg:mx-auto text-left ">
                            ...
                            <ul className="text-sm  transition-all duration-500">
                                ...
                                <li className="mb-6">
                                    <Link to={'/'} className="text-gray-300 hover:text-white">Customer Support</Link>
                                </li>

                                <li className="mb-6">
                                    <Link to={'/'} className=" text-gray-300 hover:text-white">License</Link>
                                </li>
                    ...
                    <div className="py-7 border-t border-gray-200">
                        <div className="flex items-center justify-center">
                            <span className="lg:text-[18px] text-gray-300">
                                ©<a href="#" className="ml-1">Sayu Japthai</a> {formattedDate}, All rights reserved.
                            </span>
                        </div>
                    </div>
                </div>
