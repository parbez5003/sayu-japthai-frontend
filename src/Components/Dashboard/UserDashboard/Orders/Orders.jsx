...

        {
          orderData.length === 0 ? (
            <div className=" flex flex-col items-center justify-center h-screen fonts-normal">
              ...
              <Link to={'/'}>
                <button type="button" class="px-5 py-3 text-lg  text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 "> Order Now  </button>
              </Link>
            </div>
          ) : (
              ...
              >
                <div className="md:flex items-center justify-between px-2">
                  ...
                  <div className="md:flex flex-col sm:flex-row items-center">
                    <label htmlFor="sort" className="mr-2 text-gray-800 mx-auto lg:text-xl">
                      Sort by Payment:
                    </label>
                    <select
                      id="sort"
                            ...
                            {order?.foods?.map((food, index) => (
                              ...
                              >
                                ...
                                <td className="border bg-white border-gray-200 p-2 text-sm md:text-md text-center">
                                  ...
                                  {
                                    order?.isOrderCancel ? <div className="opacity-60 cursor-not-allowed">
                                      {order?.isDelivered
                                        ? <div className=" text-white bg-green-700 p-1 rounded">
                                          Delivered
                                        </div> : <div className="text-white  bg-red-700 p-1 rounded">
                                          Processing
                                        </div>}
                                    </div> : <div>
                                      {order?.isDelivered
